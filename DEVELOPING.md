...
The system is setup via GitHub Actions to build all pull requests in CI. Further, it will build master branch to deploy to the Sonatype snapshot repository from GitHub. See the `.github/workflows/maven.yml` for details.
