...
public interface Manipulator
{
     ...
     */
    Set<MavenProject> applyChanges( List<MavenProject> projects, ManipulationSession session )
        throws ManipulationException;
